...
const movieStore = {
  ...
  mutations: {
    ...
    removeComment(state, payload) {
      const index = state.movie.comments.findIndex(
    ...
    unlikeMovie(state, payload) {
      ...
      if (index >= 0) {
        ...
        const user = state.Movies[index].Likers.findIndex(
      ...
      if (index >= 0) {
        const user = state.TodayMovies[index].Likers.findIndex(
          v => v.id == payload.userId
        );
      ...
      index = state.LatestMovies.findIndex(v => v.id == payload.movieId);
      if (index >= 0) {
        const user = state.LatestMovies[index].Likers.findIndex(
          v => v.id == payload.userId
        );
  ...
  actions: {
    loadFullMovies({ commit }, payload) {
      axios
        .get(`http://localhost:3001/movies?offset=${payload.offset}`, {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
          commit("setMovies", result.data.movies);
          commit("setMoviescnt", result.data.cnt);
        })
        .catch(error => {
          console.error(error);
        });
    },
    loadTodayMovies({ commit }) {
      axios
        .get("http://localhost:3001/movies/today", {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
    ...
    loadLatestMovies({ commit }) {
      axios
        .get("http://localhost:3001/movies/latest", {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
    ...
    loadMovie({ commit }, payload) {
      axios
        .get(`http://localhost:3001/post/movie/${payload.movieId}`, {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
    ...
    likeMovie({ commit }, payload) {
      axios
        .post(
          `http://localhost:3001/post/${payload.movieId}/like`,
          {},
          {
            withCredentials: true
          }
    ...
    removeLike({ commit }, payload) {
      axios
        .delete(`http://localhost:3001/post/${payload.movieId}/like`, {
          withCredentials: true
        })
        .then(result => {
    ...
    addComment({ commit }, payload) {
      axios
        .post("http://localhost:3001/post/comment", payload, {
          withCredentials: true
        })
        .then(result => {
    ...
    removeComment({ commit }, payload) {
      axios
        .delete(`http://localhost:3001/post/comment/${payload.commentId}`, {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
    ...
    loadLiked({ commit }, payload) {
      axios
        .get(
          `http://localhost:3001/profile/movie?limit=${payload.limit}&offset=${payload.offset}`,
          {
            withCredentials: true
          }
        )
    ...
    loadComments({ commit }, payload) {
      console.log(payload);
      axios
        .get(`http://localhost:3001/post/${payload.movieId}/comments`, {
          withCredentials: true
        })
        .then(result => {
    ...
    searchMovie({ commit }, payload) {
      ...
      axios
        .post(
          `http://localhost:3001/movies/search?offset=${payload.offset}`,
          payload,
          {
            withCredentials: true
          }
    ...
    registerMovie({ commit }, payload) {
      ...
      console.log(payload);
      axios
        .post("http://localhost:3001/movie", payload, {
          withCredentials: true
        })
        .then(result => {
          console.log(result.data);
