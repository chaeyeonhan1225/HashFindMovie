<template>
    <div class="pa-3">
        ...
        <v-row>
            ...
            <v-row class="mt-3">
                <v-text-field lavel="영화 제목" placeholder="영화 제목" filled rounded dense v-model="title"
                    append-icon="mdi-magnify" @click:append="searchMovie()" />
            </v-row>
            <v-expansion-panels flat outlined>
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-select v-model="selectedGerne" label="장르" :items="gerne" aria-placeholder="장르">
                                </v-select>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-select v-model="selectedCountry" label="국가" :items="country">
                                </v-select>
                            </v-col>
                        </v-row>
                    </v-expansion-panel-content>
